 ...
 */
public class CategoryHotelsFragment extends Fragment implements CategoryListAdapter.CustomButtonListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        categories.add(new CategoryList(R.string.accommodation, R.drawable.category_accommodation, R.string.category_accommodation_description, R.string.category_enter, R.drawable.category_button));
