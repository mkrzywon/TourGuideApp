 ...
 */
public class CategoryNatureFragment extends Fragment implements CategoryListAdapter.CustomButtonListener {

    public CategoryNatureFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        categories.add(new CategoryList(R.string.city_nature, R.drawable.category_nature, R.string.category_nature_description, R.string.category_enter, R.drawable.category_button));
