 ...
 */
public class CategoryFoodFragment extends Fragment implements CategoryListAdapter.CustomButtonListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        categories.add(new CategoryList(R.string.food_facilities, R.drawable.category_food, R.string.category_food_description, R.string.category_enter, R.drawable.category_button));
