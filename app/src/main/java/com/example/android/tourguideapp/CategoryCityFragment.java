 ...
 */
public class CategoryCityFragment extends Fragment implements CategoryListAdapter.CustomButtonListener {

    public CategoryCityFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        categories.add(new CategoryList(R.string.city_outlook, R.drawable.category_city, R.string.category_city_description, R.string.category_enter, R.drawable.category_button));
    ...
    public void onButtonClickListener() {
        ...
        changeFragment(new ListCityFragment());
