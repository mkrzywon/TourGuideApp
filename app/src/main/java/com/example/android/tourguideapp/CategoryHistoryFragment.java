 ...
 */
public class CategoryHistoryFragment extends Fragment implements CategoryListAdapter.CustomButtonListener {

    public CategoryHistoryFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        categories.add(new CategoryList(R.string.history_of_legnica, R.drawable.category_history, R.string.category_history_description, R.string.category_enter, R.drawable.category_button));
    ...
    public void onButtonClickListener(int position) {
        ...
        changeFragment(new ListHistoryFragment());
